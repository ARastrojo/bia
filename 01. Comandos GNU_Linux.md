...
![desktop](https://github.com/ARastrojo/bia/blob/cb92e93341aa960f7c389ad983bec62e345dde85/images/desktop.png)

![terminal](./images/terminal.png)

# ¿Cómo obtener ayuda sobre un comando? 

Para obtener ayuda sobre el uso de cualquier comando de _bash_ (_shell más habitual en GNU/Linux) podemos recurrir al [manual oficial de _bash_](https://www.gnu.org/software/bash/manual/bash.html), pero también podemos obtener ayuda directamente en el terminal usando el siguiente comando:
