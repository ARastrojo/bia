...
rm ./mi_fichero.txt
```
Esto no parece muy útil ahora mismo, pero lo será más adelante.
...
Otra cosa importante que mencionar es que las extensiones de los archivos (_.txt_, _.pdf_) sólo sirven para que el sistema operativo sepa con qué programa específico debe abrirlos.  
...
¿Cuántos hay? Muchos... ¿Cómo podemos contarlos? ¿Manualmente? 
